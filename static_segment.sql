...
--
-- Table structure for table `static_segment`
--

DROP TABLE IF EXISTS `static_segment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `static_segment` (
...
--
-- Dumping data for table `static_segment`
--

LOCK TABLES `static_segment` WRITE;
/*!40000 ALTER TABLE `static_segment` DISABLE KEYS */;
INSERT INTO `static_segment` VALUES (1,'TASK'),(2,'MESSAGE');
...
-- Dump completed on 2021-10-15 19:39:29
