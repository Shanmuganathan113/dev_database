...
--
-- Dumping data for table `static_role`
--

LOCK TABLES `static_role` WRITE;
/*!40000 ALTER TABLE `static_role` DISABLE KEYS */;
INSERT INTO `static_role` VALUES (1,'TEAM_LEAD','Leads team, creating tasks and organising the team tasks'),(2,'TEAM_MEMBER','Performs the tasks assigned by team lead'),(3,'GLOBAL_ADMIN','Monitors all acitvities of the entire system');
